...
def loveai_Namine(inMSG):
    ...
    elif (inMSG[0] == 'Hello, Namine' or inMSG[0] == 'Hello, Namine ' or inMSG[0] == 'Namine: hello' or inMSG[0] == 'Namine: hello ' or inMSG[0] == 'Namine: Hello' or inMSG[0] == 'Namine: Hello ' or inMSG[0] == 'Hello Namine ' or inMSG[0] == 'Hello Namine') and inMSG[4] != 'Daisy':
        loveai_send(inMSG, 'Hello~!')
